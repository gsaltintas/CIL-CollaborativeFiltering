...
class NeuMF(torch.nn.Module):
    ...
    def load_pretrain_weights(self):
        ...
        a = config['alpha']
        self.affine_output.weight.data = torch.cat([a * mlp_model.affine_output.weight.data, (1 - a) * gmf_model.affine_output.weight.data], dim=-1)
        self.affine_output.bias.data = a * mlp_model.affine_output.bias.data + (1 - a) * gmf_model.affine_output.bias.data
